...
public class CreateDestinationConfirmAction extends ActionSupport implements SessionAware{
	...
	public String execute(){
		...
		userAddressErrorMessageList = ic.doCheck("住所", userAddress, 10, 50, true, true, true, true, true, true);
	...
	public void seFamilyNameKanaErrorMessageList(List<String> familyNameKanaErrorMessageList) {
